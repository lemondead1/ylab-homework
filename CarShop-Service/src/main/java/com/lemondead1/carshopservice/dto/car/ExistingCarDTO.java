...
public record ExistingCarDTO(@Schema(description = "The car's id.") int id,
                             @Schema(description = "The car's brand.", example = "Renault") String brand,
                             ...
                             int productionYear,
                             @Schema(description = "The car's price.", example = "300000") int price,
                             @Schema(description = "The car's condition.", example = "Like new") String condition,
                             @Schema(description = "True if the car can be purchased.") boolean availableForPurchase) { }